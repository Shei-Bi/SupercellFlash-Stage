...
namespace sc
{
	namespace flash
	{
		void TextFieldOriginal::load(SupercellSWF& swf, uint8_t tag)
		{
		...
		void TextFieldOriginal::save(SupercellSWF& swf) const
		{
		...
		uint8_t TextFieldOriginal::tag(SupercellSWF&) const
		{
		...
		void TextFieldOriginal::save_data(SupercellSWF& swf, uint8_t tag) const
		{
		...
		bool TextFieldOriginal::is_textfield() const
		{
			return true;
		}
	}
